...
export default async function WebsitesPlaygroundPage() {
    ...
    return (
      <div className="p-6">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-3xl font-bold mb-4">Websites Playground</h1>
  ...
  return (
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Websites Playground</h1>
        <div className="space-y-6">
          {surveyResponses.map((response) => (
            <Card key={response.id}>
              <CardHeader>
                <CardTitle>Website Survey Response</CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {response.websiteType && (
                    <div>
                      <h3 className="font-semibold mb-2">Website Type</h3>
                      <Badge variant="default">{response.websiteType}</Badge>
                    </div>
                  )}
                  ...
                  {response.designStyle && (
                    <div>
                      ...
                      <Badge variant="secondary">{response.designStyle}</Badge>
                    </div>
                  )}
                </div>
                ...
                {response.platforms && response.platforms.length > 0 && (
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {response.platforms.map((platform: string, index: number) => (
