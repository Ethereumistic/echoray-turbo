...
export default async function IntelligencePlaygroundPage() {
  ...
  // Fetch user's survey responses filtered by intelligence
    ...
    return (
      <div className="p-6">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="text-3xl font-bold mb-4">Intelligence Playground</h1>
  ...
  return (
    <div className="p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6">Intelligence Playground</h1>
        <div className="space-y-6">
          {surveyResponses.map((response) => (
            <Card key={response.id}>
              <CardHeader>
                <CardTitle>Intelligence Survey Response</CardTitle>
                <CardDescription>
